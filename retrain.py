...
def main(_):
    ...
    #saver = tf.train.import_meta_graph('saved/train-1999.meta')
    #saver.restore(sess, "saved/train-1999")
    ...
    for i in range(FLAGS.how_many_training_steps):
        ...
        if (i % FLAGS.eval_step_interval) == 0 or is_last_step:
            ...
            saver.save(sess, "saved/train-model")
...
if __name__ == '__main__':
    ...
    parser.add_argument(
        '--image_dir',
        type=str,
        default='work/signs/photos',
        help='Path to folders of labeled images.'
    )
    parser.add_argument(
        '--output_graph',
        type=str,
        default='work/signs/retrained_graph.pb',
        help='Where to save the trained graph.'
    )
    parser.add_argument(
        '--output_labels',
        type=str,
        default='work/signs/retrained_labels.txt',
        help='Where to save the trained graph\'s labels.'
    )
    parser.add_argument(
        '--summaries_dir',
        type=str,
        default='work/signs/log',
    ...
    parser.add_argument(
        '--bottleneck_dir',
        type=str,
        default='work/signs/bottlenecks',
